...
object Repository {
    fun getPosts(): Single<Response<List<MainActivity.Adapter.Item>>> = NetworkSource.getPosts()
    ...
    object NetworkSource {
        ...
        fun getPosts() = postApi.getPosts() ?: throw IllegalStateException("Network Error")
    }
}
